...
let activitiesSec = document.getElementById("ActSec"); 
// all function
allBtn.addEventListener("click", (btn) => {
  ...
  activitiesSec.style.display = "block";
});
...
// activities function
activitiesBtn.addEventListener("click", (btn) => {
  allBtn.classList.remove("active");
  webBtn.classList.remove("active");
  graphicBtn.classList.remove("active");
  vectorBtn.classList.remove("active");
...
const textArray = ["Flutter Developer", "Graphic Designer", "Vector Artist", "2D Animator"];
